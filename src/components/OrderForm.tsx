                ...
                <div className="flex flex-col sm:flex-row w-full mt-4">
                    ...
                    <div className="w-[100%] sm:w-[40%] flex items-end ml-0 sm:ml-12 mb-10">
                        <div className="w-full mt-5">
                            <h4 className="font-bold text-[16px] leading-[16px]">Need help? Contact us!</h4>
                            <p className="font-normal text-[16px] mt-3 text-gray-500">Please call:</p>
                            <h5 className="font-bold text-[20px] leading-[20px]">+234 123 456 789</h5>
                        </div>
                    </div>
