...
const ProductCard: React.FC<productCardProps> = ({productPrice, productTitle, productSize, productFlavour}) => {
  return (
		<div className="flex flex-col w-[250px] h-fit bg-amber-100 items-center border border-bg-cyan-300 rounded-2xl">
			...
			<div className="bg-white w-full py-2 rounded-b-2xl">
				...
				<p className="font-roboto font-semibold text-[16px] leading-[24px] text-gray-500 my-1 px-2 capitalize">
					{productFlavour}
				</p>
				<div className="my-2 flex flex-row justify-between px-2">
					...
					<Button styles="text-[12px] font-roboto bg-white px-6">Read More</Button>
				</div>
			</div>
		</div>
	);
